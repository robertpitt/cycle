...
import type { GitAdapterError, RemoteFetchError, RemotePushError } from "../errors/index.ts";
...
export class Git extends Context.Service<Git, GitService>()("@cycle/git-db/Git") {}

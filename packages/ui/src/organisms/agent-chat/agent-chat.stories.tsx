...
const shellArgs: AgentChatShellProps = {
  ...
  threads: [
    ...
    },
    {
      ...
      runtimeMode: "workspace-write",
      status: "active",
      summary: "Checking the repository index update path after a branch rename.",
      thinkingLevel: "medium",
      title: "Repair repository index after branch rename",
      unreadCount: 2,
      updatedAt: "2026-06-16T10:17:00.000Z",
    },
    {
      activeTurnId: null,
      createdAt: "2026-06-16T06:45:00.000Z",
      id: "thread-review-a",
      lastError: "Agent Work failed.",
      model: "gpt-5-codex",
      origin: { kind: "issue-comment", issueId: "UKN-BTJ2M", repositoryId: "repo-cycle" },
      providerId: "codex",
      runtimeMode: "workspace-write",
      status: "error",
      summary: "Agent Work failed.",
      thinkingLevel: "medium",
      title: "Codex review: UKN-BTJ2M",
      updatedAt: "2026-06-16T02:20:00.000Z",
    },
    {
      activeTurnId: null,
      createdAt: "2026-06-15T23:30:00.000Z",
      id: "thread-long",
      model: "gpt-5-codex",
      providerId: "codex",
      runtimeMode: "workspace-write",
      status: "active",
      summary: "Chat turn cancellation requested.",
      thinkingLevel: "medium",
      title:
        "Find some bucks in [repo:falcon](cycle-repository:repo_bb228) pos-hub-cl with the smallest testable fix",
      updatedAt: "2026-06-16T01:55:00.000Z",
    },
    {
      activeTurnId: null,
      ...
      id: "thread-waiting",
      model: "gpt-5-codex",
      origin: { kind: "agent-work", jobId: "job-3821", repositoryId: "repo-cycle" },
      providerId: "codex",
      runtimeMode: "read-only",
      status: "waiting",
      summary: "Waiting for approval before editing generated migration files.",
      thinkingLevel: "medium",
      title: "Prepare Jira connector migration review",
    ...
    },
    {
      ...
      status: "draft",
      summary:
        "Can you create a new feature ticket in [repo:cycle](cycle-repository:repo_16371) to add support for Jira in the connector?",
      thinkingLevel: "medium",
      title: "Can you create a new feature ticket in [repo:cycle](cycle-repository:repo_16371)",
      updatedAt: "2026-06-15T23:08:00.000Z",
    },
  ],
};

      ...
      <div className="min-w-[980px]">
        {loading ? (
          Array.from(
            ...
            (_, index) => (
              <div
                className="grid min-h-12 grid-cols-[28px_86px_minmax(220px,1fr)_minmax(260px,0.9fr)_68px_40px] items-center gap-3 border-b border-border px-7 last:border-b-0"
                key={index}
              >
                <Skeleton className="h-4 w-1 rounded-full" />
                <Skeleton className="h-4 w-16" />
                <Skeleton className="h-4 w-3/4" />
                <Skeleton className="h-7 w-48 justify-self-end rounded-full" />

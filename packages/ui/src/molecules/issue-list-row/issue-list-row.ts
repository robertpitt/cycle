...
export const IssueListRow = React.forwardRef<HTMLDivElement, IssueListRowProps>(
  function IssueListRow(
    ...
    return React.createElement(
      ...
      React.createElement("span", { className: "font-medium text-muted-foreground" }, id),
      React.createElement(
        "div",
        ...
        React.createElement("span", { className: "truncate font-semibold text-foreground" }, title),
      ),
      React.createElement(
        "div",
        ...
        hiddenMetaCount > 0
          ? React.createElement(
              ...
              {
                className:
                  "inline-flex h-7 items-center rounded-full border border-border bg-popover px-2 text-sm text-muted-foreground",
        ...
        updateCount
          ? React.createElement(
              ...
              React.createElement(Clock3, { "aria-hidden": true, className: "size-3.5" }),
              updateCount,
            )
          : null,
      ),
      React.createElement("span", { className: "justify-self-end text-muted-foreground" }, date),
      React.createElement(
        Avatar,
        { className: "size-6 justify-self-end" },
        assigneeImage ? React.createElement(AvatarImage, { alt: "", src: assigneeImage }) : null,

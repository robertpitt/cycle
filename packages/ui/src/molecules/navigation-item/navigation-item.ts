  ...
  function NavigationItem(
    ...
    return React.createElement(
      Element,
      {
        ...
        tabIndex: href && disabled ? -1 : props.tabIndex,
      ...
      icon
        ...
        : null,
      React.createElement("span", { className: "min-w-0 flex-1 truncate" }, label),
      count !== undefined && count !== null
        ? React.createElement(
            "span",
            {
              className:
                "ml-auto rounded bg-muted px-1.5 py-0.5 text-[11px] font-medium text-muted-foreground",
            },
            count,
          )
        : null,

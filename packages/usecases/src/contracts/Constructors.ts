...
export const InboxList = constructor("InboxList");
export const InboxSummaryGet = constructor("InboxSummaryGet");
export const InboxMarkRead = constructor("InboxMarkRead");
export const InboxMarkUnread = constructor("InboxMarkUnread");
export const InboxArchive = constructor("InboxArchive");
...
export const PageCreate = constructor("PageCreate");
export const PageGet = constructor("PageGet");
export const PageList = constructor("PageList");
export const PageHierarchyList = constructor("PageHierarchyList");
export const PageUpdate = constructor("PageUpdate");
export const PageArchive = constructor("PageArchive");
export const PageRestore = constructor("PageRestore");
export const PageHistoryList = constructor("PageHistoryList");
export const PageRevisionGet = constructor("PageRevisionGet");
export const CommentList = constructor("CommentList");

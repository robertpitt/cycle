...
export const UseCaseContracts = {
  ...
  PageCreate: contract({
    aliases: [],
    category: "page",
    description: "Create a repository-scoped Markdown Page.",
    idempotency: "not-supported",
    inputSchema: RepositoryScoped(CreatePageInput),
    name: "PageCreate",
    repositoryScope: "single",
    sideEffect: "write",
    successSchema: PageDocument,
  }),
  PageGet: contract({
    aliases: [],
    category: "page",
    ...
    idempotency: "read-only",
    inputSchema: RepositoryScoped(PageGetInput),
    name: "PageGet",
    repositoryScope: "single",
    sideEffect: "read",
    successSchema: PageDocument,
  ...
  PageList: contract({
    aliases: [],
    category: "page",
    description: "List Pages without full-text search.",
    idempotency: "read-only",
    inputSchema: RepositoryScoped(PageQuery),
    name: "PageList",
    repositoryScope: "single",
    sideEffect: "read",
    successSchema: PagePage,
  }),
  PageHierarchyList: contract({
    aliases: [],
    category: "page",
    description: "List the derived Page directory hierarchy.",
    idempotency: "read-only",
    inputSchema: RepositoryScoped(PageHierarchyQuery),
    name: "PageHierarchyList",
    repositoryScope: "single",
    sideEffect: "read",
    successSchema: PageHierarchy,
  }),
  PageUpdate: contract({
    aliases: [],
    category: "page",
    ...
    idempotency: "not-supported",
    inputSchema: RepositoryScoped(UpdatePageInput),
    name: "PageUpdate",
    repositoryScope: "single",
    sideEffect: "write",
    successSchema: PageDocument,
  }),
  PageArchive: contract({
    aliases: [],
    category: "page",
    description: "Archive an active Page at an expected Page revision.",
    idempotency: "not-supported",
    inputSchema: RepositoryScoped(ArchivePageInput),
    name: "PageArchive",
    repositoryScope: "single",
    sideEffect: "write",
    successSchema: PageDocument,
  }),
  PageRestore: contract({
    aliases: [],
    category: "page",
    description: "Restore an archived Page at an expected Page revision.",
    idempotency: "not-supported",
    inputSchema: RepositoryScoped(RestorePageInput),
    name: "PageRestore",
    repositoryScope: "single",
    sideEffect: "write",
    successSchema: PageDocument,
  }),
  PageHistoryList: contract({
    aliases: [],
    category: "page",
    description: "List Page lifecycle history across moves and renames.",
    idempotency: "read-only",
    inputSchema: RepositoryScoped(PageHistoryInput),
    name: "PageHistoryList",
    repositoryScope: "single",
    sideEffect: "read",
    successSchema: PageHistoryPage,
  }),
  PageRevisionGet: contract({
    aliases: [],
    category: "page",
    description: "Read a Page at one reachable repository snapshot.",
    idempotency: "read-only",
    inputSchema: RepositoryScoped(PageRevisionInput),
    name: "PageRevisionGet",
    repositoryScope: "single",
    sideEffect: "read",
    successSchema: PageDocument,
  }),
  CommentList: contract({
    aliases: [],
    category: "comment",
    description: "List comments for a typed Cycle resource target.",
    idempotency: "read-only",
    inputSchema: RepositoryScoped(CommentListInput),
    name: "CommentList",
    repositoryScope: "single",
    sideEffect: "read",
    successSchema: CommentPage,
  }),
  CommentAdd: contract({
    aliases: [],
    category: "comment",
    description: "Add a Markdown comment to a typed Cycle resource target.",
    idempotency: "not-supported",
    inputSchema: RepositoryScoped(CommentAddInput),
    name: "CommentAdd",
    repositoryScope: "single",
    sideEffect: "write",
    successSchema: CommentDocument,
  }),
  RecordAdd: contract({
